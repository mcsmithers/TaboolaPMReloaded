...
//   public function get_refresh_token($clientId, $clientSecret,$redirect_uri,$code) {
//     $url=self::TOKEN_ENDPOINT;
//     $postdata=array("redirect_uri"=>$redirect_uri,"code"=>$code,"grant_type"=>"authorization_code");
//     $auth=$clientId . ":" . $clientSecret;
//     $response=self::fetch($url,$postdata,$auth); 
...
// public function use_refresh_token($clientId, $clientSecret,$redirect_uri,$refresh_token) {
//     $url=self::TOKEN_ENDPOINT;
//     $postdata=array("redirect_uri"=>$redirect_uri,"code"=>$code,"grant_type"=>"refresh_token");
//     $auth=$clientId . ":" . $clientSecret;
//     $response=self::fetch($url,$postdata,$auth); 
//     // Convert the result from JSON format to a PHP array 
//     $jsonResponse = json_decode( $response );
