...
$(document).ready(function () {
    ...
    Promise.all([
        ...
        .then(data => {
            ...
            $('.loader').remove();
            $('#errorContainer').prepend('<img id="error" src="http://25.media.tumblr.com/ce041b3f3fb3379a4f3bdf190e70d31f/tumblr_muy0ypiOPt1ry46hlo1_400.gif" />')
            $('#errorContainer').html('Oh snap, something broke.  Try refreshing the page.');
            $('#errorContainer').css('display', 'block');
            $('#error-box').css('display', 'block');
    ...
    $("#start-date").change(function () {
        ...
        $('#table').prepend('<img id="loadcat" src="nyanLoader.gif" />')
        ...
        Promise.all([
            ...
            .then(data => {
                ...
                $('.loader').remove();
                $('#table').prepend('<img id="error" src="http://25.media.tumblr.com/ce041b3f3fb3379a4f3bdf190e70d31f/tumblr_muy0ypiOPt1ry46hlo1_400.gif" />')
                $('#table').remove();
                $('#errorContainer').html('Oh noes, something broke. Try again later or refresh the page. ');
                $('#error-box').css('display', 'block');
                $('#errorContainer').css('display', 'block');
                document.getElementById("errorContainer").style.color = "red";
                console.log(err);
    ...
    $("#end-date").change(function () {
        ...
        Promise.all([
            ...
            .then(data => {
                ...
                $('.loader').remove();
                $('#table').prepend('<img id="error" src="uwotm8.gif" />')
                $('#table').remove();
