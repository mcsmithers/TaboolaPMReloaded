...
$(document).ready(function () {
    ...
    function performCleanupAndCalcs(merged) {
        ...
        merged = merged.map(element => {
            ...
            const rpc = !isNaN(Number(revenue / clicks)) || !isFinite(Number(revenue / clicks)) ? (revenue / clicks): '';

            const rpa = !isNaN(revenue / actions) || !isFinite(revenue / actions) ? Number(revenue / actions) : '';
