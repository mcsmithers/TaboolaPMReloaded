...
$(document).ready(function () {
    ...
    function performCleanupAndCalcs(merged) {
        ...
        merged = merged.map(element => {
            ...
            const cpc = !isNaN(Number.parseFloat(cost / clicks)) ? Number.parseFloat(cost / clicks) : '';
        
            const rpc = !Number.parseFloat(cost / clicks).toFixed(2);

            const rpa = Number.parseFloat(cost / actions).toFixed();
