...
$(document).ready(function () {
    ...
    function buildTableBodyEntries(merged) {
        ...
        // // Paginate that shiznit with d3
        var totalTbodies = $('#table tbody').length ;
        console.log('total tbodies: ', totalTbodies);
        ...
        function redraw (start) {
            d3.select("table").selectAll("tbody")
              .style("display", function(d,i) {
                  console.log(i);
                  console.log('d is ',d);
                return i >= d && i < start + 10 ? null : "none";
            })
        }
        redraw(0);
