...
$(document).ready(function () {
    ...
    function performCleanupAndCalcs(merged) {
        ...
        merged = merged.map(element => {
            ...
            const profit = !isNaN(element.profit) ? Number.parseFloat(revenue - cost) : '';
            const profitMargin = !isNaN(element.profit) ? Number.parseInt(profit / revenue) : '';
                
            const cpc = !isNaN(element.profit) ? Number.parseFloat(cost / clicks) : '';
        
            const rpc = !isNaN(element.profit) ? Number.parseFloat(cost / clicks) : '';

            const rpa = !isNaN(element.profit) ? Number.parseFloat(cost / actions) : '';
