...
$(document).ready(function () {
    ...
    function performCleanupAndCalcs(merged) {
        ...
        merged = merged.map(element => {
            ...
            const revenue = !isNaN(element.cost) ? Number.parseFloat(element.revenue): '';
            ...
            const affiliate = !isNaN(element.affiliate) ? element.affiliate : '';
        
            const offer = !isNaN(element.offer) ? element.offer : '';
        
            const profit = !isNaN(element.revenue - element.cost) ? Number.parseFloat(revenue - cost) : '';
            ...
            const rpa = !isNaN(Number.parseFloat(revenue / actions)) || !isFinite(Number.parseFloat(revenue / actions)) ? Number.parseFloat(revenue / actions).toFixed(2) : '';
