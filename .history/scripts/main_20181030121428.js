...
$(document).ready(function () {
    ...
    const getOpenMail = (startDateSelect, endDateSelect) => $.ajax({
        ...
        .then(response => {
            ...
            // First let's fix up the keys so they work later
    ...
    Promise.all([
        ...
        .then(data => {
            ...
            $('.loader').remove();
            $('#errorContainer').prepend('<img id="error" src="uwotm8.gif" />')
    ...
    $("#end-date").change(function () {
        ...
        $('#table').prepend('<p>Loading...</p>');
        $('#table').prepend('<img id="error" src="nyanLoader.gif" />')
