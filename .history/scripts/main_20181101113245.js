        ...
        $('.paginated').each(function () {
            ...
            $table.bind('repaginate', function () {
                if (pages > 1) {
                    ...
                    $('<button class="button secondary" id="first-button"></button>').text(' « First ').bind('click', function () {
                        currentPage = 0;
                    ...
                    $('<button class="button secondary" id="last-button"> Last » </button>').bind('click', function () {
                        currentPage = pages - 1;
                        $table.trigger('repaginate');
                    }).appendTo(pager);
