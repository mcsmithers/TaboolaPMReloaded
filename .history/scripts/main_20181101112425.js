...
$(document).ready(function () {
    ...
    function buildTableBodyEntries(merged) {
        ...
        $('.paginated').each(function () {
            ...
            // Show a result count to help show but hide duplicates when we re-draw
            ...
            function getCurrentRows(rowsPerPage, currPage, rowCount) {
                var from = (itemsPerPage * currentPage) - itemsPerPage + 1;
                var to = (itemsPerPage * currentPage) > rowCount ? rowCount : itemsPerPage * currrentPage;
                console.log( "Viewing rows " + from + " to " + to + " of " + rowCount);
            }
            ...
            $table.bind('repaginate', function () {
                if (pages > 1) {
                    ...
                    //hide the details ont eh same day per pagination
                    if (startDateSelect != endDateSelect) {
                    ...
                    $('<button class="button hollow" id="last-button"> Last » </button>').bind('click', function () {
                        currentPage = pages - 1;
                        var itemsPerPage = $(
                            'tbody .detail-row:visible').length;
