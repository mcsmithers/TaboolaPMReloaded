...
$(document).ready(function () {
    ...
    function performCleanupAndCalcs(merged) {
        ...
        merged = merged.map(element => {
            ...
            const clicks = Number.parseInt(merged[element].clicks);
        
            const actions = Number.parseInt(merged[element].actions);
        
            const cost = Number.parseFloat(merged[element].cost);
        
            const revenue = Number.parseFloat(merged[element].revenue);
        
            const name = merged[element].name;
        
            const affiliate = merged[element].affiliate;
        
            const offer = merged[element].offer;
