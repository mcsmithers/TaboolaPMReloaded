...
$(document).ready(function () {
    ...
    const getYahoo = (startDateSelect, endDateSelect) => $.ajax({
        type: "GET",
    ...
    function failFunction(response) {
        ...
        $('#error-box').show();
        $('.loader').remove();
        $('#errorContainer').html('Oh no! Something broke. <br/><b>Error: ' + response .statusCode.name + '</b>.  Try refreshing the page.');
