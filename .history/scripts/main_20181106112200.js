...
$(document).ready(function () {
    ...
    function mergeData(...args) {
        ...
        console.log('post merge pre cleanup ', merged);
    ...
    function performCleanupAndCalcs(merged) {
        ...
        merged.forEach(function (element, index) {
            ...
            if (!isNaN(clicks)) {
                merged[index].clicks = Number.parseInt(clicks);
                calcs.push(clicks);
            } else {
                merged[index].clicks = '';
                calcs.push(clicks);
            ...
            if (!isNaN(spend) && spend !== 0) {
                merged[index].spend = Number.parseFloat(spend);
                calcs.push(spend);
            } else {
                merged[index].spend = '';
                calcs.push(spend);
            ...
            //     const profit = Number(spend - revenue);
            ...
            //         merged[index].profitMargin = Number(profitMargin);
            ...
            //         merged[index].cpc = Number.parseFloat(cpc);
            //         calcs.push(cpc);
            //     } else {
            //         merged[index].cpc = '';
            //         calcs.push(cpc);
            ...
            //         merged[index].rpc = Number.parseFloat(rpc);
            //         calcs.push(rpc);
            //     } else {
            //         merged[index].rpc = '';
            //         calcs.push(rpc);
            ...
            //         merged[index].rpa = Number.parseFloat(rpa);
            //         calcs.push(rpa);
            //     } else {
            //         merged[index].rpa = '';
            //         calcs.push(rpa);
    ...
    function buildTableBodyEntries(merged) {
        ...
        //     val[acc.affId_offId].spend += Number.isFinite(acc.spend) ? Number.parseFloat(acc.spend) : 0;
        ...
        //     val[acc.affId_offId].affiliate = acc.offer;

        //     val[acc.affId_offId].cpc = Number.isFinite(val[acc.affId_offId].spend / val[acc.affId_offId].clicks) ? Number.parseFloat(acc.cpc) : 0;
