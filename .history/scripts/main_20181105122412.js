...
$(document).ready(function () {
    ...
    function buildTableBodyEntries(merged) {
        ...
        // the chain select here pushes the datum onto the different buttons
...
// // show the number of results
        ...
        const visibleDetailRows = $('tr.detail-row').length;
        const visibleSummaryRows = $('tr.summary').length;
        if (startDateSelect == endDateSelect){
            console.log('showing ', visibleDetailRows , ' of ', shownRows);
        }

        if (startDateSelect != endDateSelect){
            console.log('showing ', visibleSummaryRows , ' of ', shownRows);
        }
