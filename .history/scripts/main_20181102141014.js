...
$(document).ready(function () {
        ...
        function buildTableBodyEntries(merged) {
            ...
            $('.paginated').each(function () {
                ...
                // if (startDateSelect != endDateSelect){
                //     $table.find(
                //         'tbody tr:not(:has(th))').hide().slice(currentPage * itemsPerPage, (currentPage) * itemsPerPage).show();
                // }
                ...
                // var rowCount = $('#table tbody tr.detail-row').length;
                // var numOfVisibleRows = $('tbody tr.detail-row:visible').length;
                // console.log('row count is ', rowCount, ' and visible rows are ', numOfVisibleRows);
    ...
    // // Export the table
    TableExport.prototype.formatConfig.xlsx.buttonContent = 'Export to Excel'; TableExport.prototype.formatConfig.csv.buttonContent = 'Export to CSV';
    ...
    $("body").find("*").removeAttr("disabled"); $("body").find("a").unbind("click");
}
