    ...
    function buildTableBodyEntries(merged) {
        ...
        $('.paginated').each(function () {
            ...
            if (startDateSelect == endDateSelect) {
                var sameDayShownRows = merged.length;
                $('#table').prepend('<div id="count">' + sameDayShownRows + ' total results</div>');
                var count;
            ...
            if (startDateSelect != endDateSelect) {
                ...
                var shownRowsHeader = shownRows - 1;
                $('#table').prepend('<div id="count">' + shownRows + ' total results</div>');
                var count;
                $('div.count').each(function () {
                    theHidden = $(this).attr('id');
                    if (theHidden == myFeatured) {
