...
$(document).ready(function () {
    ...
    function buildTableBodyEntries(merged) {
        ...
        const searchString = "sets";
        const options = { keys: ['name', 'affiliate', "date", "offer"], threshold: 0.2, caseSensitive: false };
        const f = new Fuse(merged, options);
        const output = f.search($('.search')),
        i;
