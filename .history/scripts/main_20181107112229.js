...
$(document).ready(function () {
    ...
    function performCleanupAndCalcs(merged) {
        ...
        merged.forEach(function (element, index) {
            ...
            const clicks = Number.parseFloat(merged[index].clicks).toFixed(0);
            if (!isNaN(clicks)) {
                merged[index].clicks = Number.parseFloat(clicks).toFixed(0);
                calcs.push(clicks);
            } else {
                merged[index].clicks = '';
                calcs.push(clicks);
            ...
            const cost = Number.parseFloat(merged[index].cost).toFixed(2);
            if (!isNaN(cost) && cost !== 0) {
                merged[index].cost = Number.parseFloat(cost).toFixed(2);
                calcs.push(cost);
            } else {
                merged[index].cost = '';
                calcs.push(cost);
            ...
            const profit = Number.parseFloat(revenue - cost).toFixed(2);
